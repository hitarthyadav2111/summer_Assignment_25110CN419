        ...
        switch(option){
            ...
            switch(issued_book){
                ...
                case 10:
                    ...
                    break;
                default:
                    System.out.println("Inavlid Choice!! Please choose carefully.");
                    break;
            }
            System.out.println("Enter 1 if you want to issue more books,any other number to exit");
            int a=in.nextInt();
            if(a!=1){
        ...
        case 2:
            ...
            switch(returning_book){
                case 1:
                    ...
                    break;
                case 2:
                    System.out.println("Issuing book : "+title.get(returning_book-1));
                    System.out.println("Book ID : "+book_id.get(returning_book-1));
                    stock.set(returning_book-1,stock.get(returning_book-1)+1);
                    break;
                case 3:
            ...
            System.out.println("Enter 1 if you want to return more books,any other number to exit");
            int a=in.nextInt();
            if(a!=1){
                System.out.println("Thank You!!");
                break;
